...
public class ItemController {
	...
	// 자료입력내용 저장(파일을 외부저장소저장완료후, 디비 저장)
	...
	public String register(Item item, Model model) throws Exception {
		...
		// 절대중복되지않는파일명_kkk.jpg, _kkk.jpg -> d:\ upload\절대중복되지않는파일명_kkk.jpg
	...
	private String uploadFile(String originalName, byte[] fileData) throws Exception {
		...
		// String createdFileName = "a1b2c3d4-e5f6-7890-1234-567890abcdef_kkk.jpg"
		String createdFileName = uid.toString() + "_" + originalName;
		// D:/upload/a1b2c3d4-e5f6-7890-1234-567890abcdef_kkk.jpg 파일생성
	...
	private boolean deleteFile(String fileName) throws Exception {
		...
		// d:/upload/uuid_kkk.jpg => 파일로 인식되는 개체되는 순간.
